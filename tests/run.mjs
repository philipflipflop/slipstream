...
execSync(
  'node node_modules/typescript/bin/tsc src/aircraft/flightModel.ts src/aircraft/catalog.ts src/aircraft/autopilot.ts src/world/rings.ts src/world/terrainBuilder.ts src/nav/route.ts ' +
