...
execSync(
  'node node_modules/typescript/bin/tsc src/aircraft/flightModel.ts src/aircraft/catalog.ts src/aircraft/autopilot.ts src/world/rings.ts src/world/traffic.ts src/world/terrainBuilder.ts src/world/obstacles.ts src/nav/route.ts src/nav/ils.ts src/combat/range.ts ' +
